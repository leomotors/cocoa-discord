...
import Activities from "./__mocks__/activities.mock.json";
import {
  ActivityGroupLoader,
  ActivityManager,
  isGroupLoader,
...
describe("utils > activity (group loader)", () => {
  const loader = new ActivityGroupLoader(
    "./src/utils/__mocks__/activities.mock.json",
  );
