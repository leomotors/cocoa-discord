import "./__mocks__/stub.js";

import { describe, expect, it } from "vitest";

import { ArrayLoader, Loader } from "./loader.js";

describe("utils > loader (base)", () => {
  describe("From Object <string>", fromObject);
  describe("From Json <string>", fromJson);
});

describe("utils > loader (array)", () => {
...
function fromJson() {
  ...
  const loader = Loader.fromJson<string>(
    name,
    "./src/utils/__mocks__/usa.object.mock.json",
  );
...
function fromFile() {
  ...
  const loader = ArrayLoader.fromFile<string>(
    name,
    "./src/utils/__mocks__/usa.array.mock.json",
  );
